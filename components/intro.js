...
const Intro = () => {
  return (
    <div className="flex flex-col items-center mt-36 justify-center p-24 text-white bg-purple">
      ...
      <div className="grid grid-cols-3 gap-10 text-center mt-20">
        ...
        <div className="container bg-white p-10 rounded-lg shadow-2xl scale-110  duration-200 hover:scale-125">
          <Image src={CodeIcon} />
